        ...
        for r in range(rounds):
            ...
            with ThreadPoolExecutor(max_workers=4) as executor:
                ...
                for i, (sat_id, hap_id, _, _, direction, _) in enumerate(events, start=1):
                    ...
                    if direction == 'DL':
                        def train_sat(sat=sat, hap=hap, round_idx=r, event_idx=i):
                            print(f"round {round_idx+1}/{rounds}, events {event_idx}/{num_events}:")
                            local_w = sat.weights
                        ...
                        futures.append(executor.submit(train_sat))
                    else:
